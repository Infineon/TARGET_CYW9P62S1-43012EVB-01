...
#ifndef CY8C6247FDI_D52
    #error "Unexpected target MCU; expected CY8C6247FDI-D52. There may be an inconsistency between the *.modus file and the makefile target configuration device sets."
#endif
#endif
